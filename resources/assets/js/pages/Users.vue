  ...
  <div>
    ...
    <modal :active="dialogActive" @close="dialogActive = false">
      ...
      <template slot="footer">
        <button :title="submitTooltip" :class="isSubmittingClass" type="button" class="button is-primary"
                @click="createSubmit" :disabled="!canSubmit">Submit
        </button>
      </template>
    </modal>
